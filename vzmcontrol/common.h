...
#define MIG_INFO_WARM_STARTED		"Warm migration stage started"
#define MIG_INFO_COMPLETED		"Migration stage completed"
...
#define MIG_MSG_SET_IOLIMIT		"can not set iolimit %d"
